  ...
  return (
    <>
      ...
      <div onScroll={handleScroll}>
        ...
        >
          <Stack
            sx={{ backgroundColor: "white", width: "60%", height: "100vh" }}
          >
            <Box
              sx={{
                display: "flex",
            ...
            /> */}
              ...
              <Typography variant="h7" sx={{ padding: "10px 0 0 40px " }}>
                ...
                gang violence, social discrimination and isolation. But it
        ...
        <Stack direction="row" sx={{ width: "100%", height: "fit-content" }}>
          ...
          >
            <Typography padding="50px 0 0 70px">
              ...
              Philanthropy (AIP), is America’s most independent, assertive
              charity watchdog . CharityWatch does not merely repeat what a
              charity reports using simplistic or automated formulas.
              <br></br>
              <br></br>
              We dive deep to let you know how efficiently a charity will use
              your donation to fund the programs you want to support.
              CharityWatch exposes nonprofit abuses and advocates
            </Typography>
            <img
              src={img}
              alt="img"
              ...
              <Stack width="100%" justifyContent="center" alignItems="center">
                ...
                >
                  ...
                  >
                    ...
                    brands for you directly, but we will refer you to our
                    trusted partner who can. Learn more about our partnership
                  </Typography>
                </Box>
              </Stack>
            </Box>
